...
fn main() {
    let solutions = vec![
        ...
        // solution!(year2025, day13),
        // solution!(year2025, day14),
        // solution!(year2025, day15),
        // solution!(year2025, day16),
        // solution!(year2025, day17),
        // solution!(year2025, day18),
        // solution!(year2025, day19),
        // solution!(year2025, day20),
        // solution!(year2025, day21),
        // solution!(year2025, day22),
        // solution!(year2025, day23),
        // solution!(year2025, day24),
        // solution!(year2025, day25),
    ];
